...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-4 mb-10">
        ...
        <h1 class="text-4xl font-bold">New Category</h1>
    </div>
    ...
    <div class="glass p-8 rounded-3xl">
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" id="name" class="w-full px-5 py-3 rounded-xl bg-slate-800 border border-slate-700 focus:border-indigo-500 outline-none transition" value="{{ old('name') }}" required autofocus>
